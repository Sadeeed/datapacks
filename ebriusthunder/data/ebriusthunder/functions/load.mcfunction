...
# to .//data/ebriusthunder/functions/load.mcfunction
#
# Generated by Minecraft Script for 1.13
######
function ebriusthunder:mcscript/load
...
execute if score #seeded mcprng matches 0 run function ebriusthunder:seed
#noon check setup
